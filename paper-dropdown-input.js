...
class PaperDropdownInput extends PolymerElement {
  static get template() {
    return html`
...
`;
  ...
  static get is() { return 'paper-dropdown-input'; }
  ...
  _setupTemplate() {
    ...
    // normally a user can select an option by typing the first letter
    ...
    this._templateInstance = new TemplateClass({items: this._filtereditems});
    // Insert the instance's DOM somewhere, e.g. element's shadow DOM
    this.
    this.shadowRoot.appendChild(this._templateInstance.root);
  }
...
window.customElements.define(PaperDropdownInput.is, PaperDropdownInput);